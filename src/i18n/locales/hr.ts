...
const hr: Record<TranslationKey, Phrase> = {
  ...
  "guess.hint": "Dijakritici nisu obavezni · ćirilica radi · točni nazivi se upisuju sami",

  "feedback.duplicate": "{name} — već pronađeno",
  "feedback.shared": "Obje su na karti",
  "feedback.outOfScope": "{name} nije u ovoj rundi",
  "feedback.tooBroad": "„{value}“ obuhvaća više općina",
  ...
  "map.hint": "Povuci za pomicanje · kotačić za zum",
  "map.zoomIn": "Približi",
  "map.zoomOut": "Udalji",
  "map.reset": "Vrati prikaz",
  "map.zoomTo": "Približi {name}",
  "map.satellite": "Satelitska snimka",

  "source.imagery": "Snimke: {credit}",
  "source.note":
